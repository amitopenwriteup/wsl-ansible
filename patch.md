...
- [ ] Lab environment ready (Section 3)
- [ ] Module research worksheet done (Section 4)
...
| Time | Section |
|---|---|
| 0:00 – 0:25 | Concepts: drift, enforcement patterns, patch design |
| 0:25 – 0:55 | Lab setup and *how to research modules* |
| 0:55 – 2:00 | **Part A** – Configuration baseline and drift |
| 2:00 – 2:10 | Break |
| 2:10 – 3:20 | **Part B** – Patch management playbook |
| 3:20 – 3:50 | **Part C** – Put it together, schedule it, quiz |
...
artifact_server: 192.168.56.1
issue_net_sha256: "REPLACE_WITH_SHA256"   # you will fill this in at step A4
